...
const UserManagement: FC = () => {
  const [activeTab, setActiveTab] = useState<TabType>('atasan');
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.tabs}>
        <button
          className={`${styles.tab} ${activeTab === 'atasan' ? styles.tabActive : ''}`}
          onClick={() => {
            setActiveTab('atasan');
            setSelectedPemohon(null);
          }}
        ...
        <button
          className={`${styles.tab} ${activeTab === 'pemohon' ? styles.tabActive : ''}`}
          onClick={() => {
      ...
      <div className={styles.content}>
        <div className={styles.mainContent}>
          <div className={styles.headerRow}>
            <div className={styles.userCount}>
              ...
              {activeTab === 'atasan' ? `${atasanUsers.length} Atasan` : `${pemohonUsers.length} Pemohon`}
            </div>
            <button
              type="button"
              className={styles.addButton}
              onClick={activeTab === 'atasan' ? handleAddAtasan : handleAddPemohon}
            >
              {activeTab === 'atasan' ? 'Tambah Atasan' : 'Tambah Pmhn'}
            </button>
          </div>
        ...
        <aside className={styles.sidePanel}>
          {activeTab === 'atasan' && selectedAtasan ? (
            <>
          ...
          ) : activeTab === 'pemohon' && selectedPemohon ? (
            <>
              <div className={styles.avatarSection}>
                <div className={styles.avatarPlaceholder}>
                  <UserIcon />
