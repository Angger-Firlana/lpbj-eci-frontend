...
import styles from './HistoryLpbjDetail.module.css';
            ...
            <div className={styles.cardContent}>
              <div className={styles.infoGrid}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <span className={styles.infoValue}>{lpbjData.pemohon}</span>
                </div>
                <div className={styles.infoItem}>
                  <span className={styles.infoLabel}>Terakhir Di Update</span>
                  <span className={styles.infoValue}>{lpbjData.terakhirDiUpdate}</span>
                </div>
                <div className={styles.infoItem}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <span className={styles.infoValue}>{lpbjData.keterangan}</span>
                </div>
              </div>
            </div>
          </div>
...
export default HistoryLpbjDetail;
